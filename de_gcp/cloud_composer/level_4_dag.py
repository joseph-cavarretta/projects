...
bq_processed_dataset   = settings['bq_processed_dataset']
...
# Activities
activities_source_object  = "raw_activities.csv"
sql_query                 = "SELECT * FROM strava.raw_activities"


export_body = {
    "exportContext": {
        "fileType": "csv",
        "uri": f"gs://{gcs_source_data_bucket}/{activities_source_object}",
        "csvExportOptions":{
...
bq_table_name = "raw_activities"
bq_table_id = f"{gcp_project_id}.{bq_raw_dataset}.{bq_table_name}"
bq_table_schema = read_json_schema("/home/airflow/gcs/data/schema/stations_schema.json")
